...
import { DonationModel, CreateDonationInput, UpdateDonationInput, DonationWithRelations } from '../donation.model';
...
export class DonationRepository extends BaseRepository<DonationModel> {
  ...
  async updateDonation(id: string, data: UpdateDonationInput): Promise<DonationModel> {
